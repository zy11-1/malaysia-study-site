      ...
      >
        <div className="max-w-7xl mx-auto px-8 flex items-center justify-between h-20">
          ...
          <button
            ...
            className="hidden md:flex items-center gap-2 px-4 py-2 rounded-full border border-emerald-500/50 text-emerald-400 hover:bg-emerald-500/10 transition-all duration-300 text-sm"
          >
            <span>🤖</span>
            <span>AI 助手</span>
          </button>
        ...
        >
          <div className="px-8 py-6 space-y-4">
            ...
            <button
              ...
              className="flex items-center gap-2 w-full text-left py-2 text-emerald-400"
            >
              <span>🤖</span>
              <span>AI 助手</span>
            </button>
